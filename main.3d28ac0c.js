            ...
            return n(t, [{
                ...
                value: function() {
                    if (this.gameStatus === ls && this.canInput) {
                        if (3 !== this.tileIndex) return this.$board.querySelectorAll("game-row")[this.rowIndex].setAttribute("invalid", ""), void this.addToast("Not enough letters");
                        this.evaluateRow()
                    }
                }
            }, {
                ...
                value: function() {
                    ...
                    for (var c = 0; c < 6; c++) {
                        ...
                        u.setAttribute("letters", this.boardState[c]), u.setAttribute("length", 3), this.evaluations[c] && (u.evaluation = this.evaluations[c]), this.$board.appendChild(u)
                    }
